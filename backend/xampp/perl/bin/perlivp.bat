...
#!perl
#line 29
    eval 'exec \Users\Daniel Vacas\Documents\proyect\mgmnt\backend\xampp\perl\bin\perl.exe -S $0 ${1+"$@"}'
...
my $perlpath = '\Users\Daniel Vacas\Documents\proyect\mgmnt\backend\xampp\perl\bin\perl.exe';
